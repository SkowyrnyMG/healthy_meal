...
1. The system displays a list of public recipes from all users
2. The list contains basic information about recipes (title, short description, nutritional values, author)
3. The user can select a recipe to see its details

#### US-013: Searching and Filtering Public Recipes

As a user, I want to search and filter public recipes to quickly find interesting items from the community.

Acceptance Criteria:

1. The user can search public recipes by title
2. The user can filter public recipes by hashtags
3. The user can filter public recipes by calorie content (below/above X kcal)
4. The user can filter public recipes by preparation time (up to X minutes)
5. The system displays results matching the search/filter criteria

#### US-014: Saving Public Recipes to Favorites

As a user, I want to save public recipes as favorites to easily return to them later.

Acceptance Criteria:

1. The user can mark a public recipe as favorite
2. The user can remove a public recipe from favorites
3. The system displays a separate list of favorite recipes (including both user's own and public recipes)
...
- `isPublic`: Allways "true" for this endpoint
