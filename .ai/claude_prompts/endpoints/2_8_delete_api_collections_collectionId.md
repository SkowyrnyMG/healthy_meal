...
Remember to save your implementation plan as `.ai/claude_prompts/endpoints/2_8_delete_api_collections_collectionId_view_implementation_plan.md`. Ensure the plan is detailed, clear, and provides comprehensive guidance for the development team.
